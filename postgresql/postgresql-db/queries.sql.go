...
SELECT id, license_key, start_date, end_date, no_of_hosts, current_hosts, is_active, license_type, kengine_support_email, notification_threshold_percentage, notification_threshold_updated_at, registry_credentials, message, description, created_at, updated_at, license_email, license_email_domain, no_of_cloud_accounts, no_of_registries, no_of_images_in_registry
FROM license
...
type UpsertLicenseParams struct {
	...
	KengineSupportEmail           string          `json:"kengine_support_email"`
	NotificationThresholdPercentage int32           `json:"notification_threshold_percentage"`
